...
// import recipes from './AssignmentData'; 
    ...
    padding: 20}}>
        {
               ...
               recipes.map( item =>
                ...
                <View style={{borderWidth:1,borderColor:'grey',borderRadius:20,width:160,minHeight:250,marginTop:25}} key={item.recipeId}>
                    <View >
                        <Image source={{ uri: item.photo_url }} style={{ width: 158, height: 180,borderRadius:20}} ></Image>
                    </View>
                    <View style={{flex:1,justifyContent:'space-between',alignItems:"center"}}>
                        <Text style={{fontWeight:350,fontSize:20,color:'black',textAlign:'center'}}>{item.title}</Text>
                        <Text>Category</Text>
                    </View>
                </View>
                </TouchableOpacity>
