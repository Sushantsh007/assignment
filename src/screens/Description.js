...
const Description = ({route}) => {
    ...
    // const array_ing=route.params.array_ing;
    ...
    // let Obj_photo_url;
    // let ing_id_2=0;
    // function getObj(ing_id){
    //     for(var i=0;i<Object.keys(ingredients_original).length;i++){
    //         ing_id_2=ingredients_original[i].ingredientId;
    //         if(ing_id==ing_id_2){
    //             Obj_name=ingredients_original[i].name;
    //             Obj_photo_url=ingredients_original[i].photo_url;                              
    ...
    padding: 20}}>
        {
            ...
            array_ing.map( item =>
                ...
                //     <View style={{borderWidth:1,borderColor:'grey',width:100,minHeight:210,marginTop:25}} key={ing_id_2}>
                    
                //     <View >
                //         <Image source={{ uri: Obj_photo_url  }} style={{ width: 158, height: 180,borderRadius:20}} ></Image>
                //     </View>
                //     <View style={{flex:1,justifyContent:'space-between',alignItems:"center"}}>
                //         <Text style={{fontWeight:350,fontSize:20,color:'black',textAlign:'center'}}>{Obj_name}</Text>
                //         <Text>{sub_items[1]}</Text>
                //     </View>
                // </View>
